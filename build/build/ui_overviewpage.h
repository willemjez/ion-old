...
public:
    ...
    QFrame *frameStashedsend;
    QVBoxLayout *verticalLayout_5;
    QHBoxLayout *horizontalLayout_5;
    QLabel *label_2;
    QLabel *labelStashedsendSyncStatus;
    QSpacerItem *horizontalSpacer_4;
    QPushButton *runAutoDenom;
    QFormLayout *formLayout;
    QLabel *label_6;
    QLabel *label_7;
    QProgressBar *stashedsendProgress;
    ...
    QLabel *stashedsendEnabled;
    QFrame *lineLastMessage;
    QLabel *stashedsendStatus;
    QPushButton *stashedsendAuto;
    QPushButton *toggleStashedsend;
    QPushButton *stashedsendReset;
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelWatchPending->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelWatchImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelImmature->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelWatchTotal->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelBalance->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelStake->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelWatchStake->setFont(font1);
        labelWatchStake->setCursor(QCursor(Qt::IBeamCursor));
        labelWatchStake->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        labelWatchAvailable->setText(QString::fromUtf8("0.000\342\200\211000\342\200\21100 ION"));
        ...
        frameStashedsend = new QFrame(OverviewPage);
        frameStashedsend->setObjectName(QStringLiteral("frameStashedsend"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(frameStashedsend->sizePolicy().hasHeightForWidth());
        frameStashedsend->setSizePolicy(sizePolicy1);
        frameStashedsend->setMinimumSize(QSize(0, 350));
        frameStashedsend->setLayoutDirection(Qt::LeftToRight);
        frameStashedsend->setFrameShape(QFrame::StyledPanel);
        frameStashedsend->setFrameShadow(QFrame::Raised);
        verticalLayout_5 = new QVBoxLayout(frameStashedsend);
        verticalLayout_5->setObjectName(QStringLiteral("verticalLayout_5"));
        horizontalLayout_5 = new QHBoxLayout();
        horizontalLayout_5->setObjectName(QStringLiteral("horizontalLayout_5"));
        label_2 = new QLabel(frameStashedsend);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setFont(font1);

        horizontalLayout_5->addWidget(label_2);

        labelStashedsendSyncStatus = new QLabel(frameStashedsend);
        labelStashedsendSyncStatus->setObjectName(QStringLiteral("labelStashedsendSyncStatus"));
        labelStashedsendSyncStatus->setStyleSheet(QStringLiteral("QLabel { color: red; }"));
        labelStashedsendSyncStatus->setText(QStringLiteral("(out of sync)"));
        labelStashedsendSyncStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);

        horizontalLayout_5->addWidget(labelStashedsendSyncStatus);
        ...
        runAutoDenom->setPalette(palette1);
        ...
        formLayout->setVerticalSpacing(11);
        label_6 = new QLabel(frameStashedsend);
        label_6->setObjectName(QStringLiteral("label_6"));

        formLayout->setWidget(0, QFormLayout::LabelRole, label_6);

        label_7 = new QLabel(frameStashedsend);
        label_7->setObjectName(QStringLiteral("label_7"));

        formLayout->setWidget(1, QFormLayout::LabelRole, label_7);

        stashedsendProgress = new QProgressBar(frameStashedsend);
        stashedsendProgress->setObjectName(QStringLiteral("stashedsendProgress"));
        stashedsendProgress->setMaximumSize(QSize(154, 16777215));
        stashedsendProgress->setValue(0);

        formLayout->setWidget(1, QFormLayout::FieldRole, stashedsendProgress);

        labelAnonymizedText = new QLabel(frameStashedsend);
        ...
        labelAnonymized = new QLabel(frameStashedsend);
        labelAnonymized->setObjectName(QStringLiteral("labelAnonymized"));
        labelAnonymized->setFont(font1);
        labelAnonymized->setText(QStringLiteral("0 ION"));

        formLayout->setWidget(3, QFormLayout::FieldRole, labelAnonymized);

        label_8 = new QLabel(frameStashedsend);
        label_8->setObjectName(QStringLiteral("label_8"));

        formLayout->setWidget(4, QFormLayout::LabelRole, label_8);

        labelAmountRounds = new QLabel(frameStashedsend);
        ...
        label_9 = new QLabel(frameStashedsend);
        label_9->setObjectName(QStringLiteral("label_9"));

        formLayout->setWidget(5, QFormLayout::LabelRole, label_9);

        labelSubmittedDenom = new QLabel(frameStashedsend);
        ...
        stashedsendEnabled = new QLabel(frameStashedsend);
        stashedsendEnabled->setObjectName(QStringLiteral("stashedsendEnabled"));

        formLayout->setWidget(0, QFormLayout::FieldRole, stashedsendEnabled);


        verticalLayout_5->addLayout(formLayout);

        lineLastMessage = new QFrame(frameStashedsend);
        ...
        stashedsendStatus = new QLabel(frameStashedsend);
        stashedsendStatus->setObjectName(QStringLiteral("stashedsendStatus"));
        stashedsendStatus->setMinimumSize(QSize(288, 43));
        stashedsendStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        stashedsendStatus->setWordWrap(true);

        verticalLayout_5->addWidget(stashedsendStatus);

        stashedsendAuto = new QPushButton(frameStashedsend);
        stashedsendAuto->setObjectName(QStringLiteral("stashedsendAuto"));
        QSizePolicy sizePolicy2(QSizePolicy::MinimumExpanding, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(stashedsendAuto->sizePolicy().hasHeightForWidth());
        stashedsendAuto->setSizePolicy(sizePolicy2);

        verticalLayout_5->addWidget(stashedsendAuto);

        toggleStashedsend = new QPushButton(frameStashedsend);
        toggleStashedsend->setObjectName(QStringLiteral("toggleStashedsend"));
        sizePolicy2.setHeightForWidth(toggleStashedsend->sizePolicy().hasHeightForWidth());
        toggleStashedsend->setSizePolicy(sizePolicy2);

        verticalLayout_5->addWidget(toggleStashedsend);

        stashedsendReset = new QPushButton(frameStashedsend);
        stashedsendReset->setObjectName(QStringLiteral("stashedsendReset"));
        sizePolicy2.setHeightForWidth(stashedsendReset->sizePolicy().hasHeightForWidth());
        stashedsendReset->setSizePolicy(sizePolicy2);
        stashedsendReset->setAutoFillBackground(false);

        verticalLayout_5->addWidget(stashedsendReset);


        verticalLayout_2->addWidget(frameStashedsend);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ion network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        label_2->setText(QApplication::translate("OverviewPage", "Stashedsend", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelStashedsendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ion network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        labelAnonymizedText->setText(QApplication::translate("OverviewPage", "Stashedsend Balance:", Q_NULLPTR));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", Q_NULLPTR));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 ION / 0 Rounds", Q_NULLPTR));
        ...
        stashedsendEnabled->setText(QApplication::translate("OverviewPage", "Enabled/Disabled", Q_NULLPTR));
        stashedsendStatus->setText(QApplication::translate("OverviewPage", "(Last Message)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        stashedsendAuto->setToolTip(QApplication::translate("OverviewPage", "Try to manually submit a Stashedsend request.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        stashedsendAuto->setText(QApplication::translate("OverviewPage", "Try Mix", Q_NULLPTR));
        toggleStashedsend->setText(QApplication::translate("OverviewPage", "Start/Stop Mixing", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        stashedsendReset->setToolTip(QApplication::translate("OverviewPage", "Reset the current status of Stashedsend (can interrupt Stashedsend if it's in the process of Mixing, which can cost you money!)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        stashedsendReset->setText(QApplication::translate("OverviewPage", "Reset", Q_NULLPTR));
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ion network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
