...
public:
    ...
    void setupUi(QDialog *MultisigDialog)
    {
        ...
        MultisigDialog->setPalette(palette);
        QFont font;
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1285, 286));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 613, 196));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 612, 165));
    ...
    void retranslateUi(QDialog *MultisigDialog)
    {
        ...
        label->setText(QApplication::translate("MultisigDialog", "TX", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("MultisigDialog", "TX", Q_NULLPTR));
        ...
        label_3->setText(QApplication::translate("MultisigDialog", "TX", Q_NULLPTR));
