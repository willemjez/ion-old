...
#include "../../../ion/src/qt/optionsmodel.h"
...
QT_MOC_LITERAL(7, 109, 24), // "stashedsendRoundsChanged"
QT_MOC_LITERAL(8, 134, 25) // "AnonymizeIonAmountChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "transactionFeeChanged\0reserveBalanceChanged\0"
    "coinControlFeaturesChanged\0"
    "stashedsendRoundsChanged\0"
    "AnonymizeIonAmountChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->stashedsendRoundsChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->AnonymizeIonAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::stashedsendRoundsChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::AnonymizeIonAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::stashedsendRoundsChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void OptionsModel::AnonymizeIonAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
