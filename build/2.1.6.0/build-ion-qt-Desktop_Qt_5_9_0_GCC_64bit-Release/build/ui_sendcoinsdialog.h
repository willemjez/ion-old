...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(874, 448);
        QPalette palette;
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 854, 164));
        ...
        checkUseStashedsend = new QCheckBox(SendCoinsDialog);
        checkUseStashedsend->setObjectName(QStringLiteral("checkUseStashedsend"));
        checkUseStashedsend->setMinimumSize(QSize(95, 0));
        checkUseStashedsend->setChecked(true);

        horizontalLayout_2->addWidget(checkUseStashedsend);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 ION", Q_NULLPTR));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 ION", Q_NULLPTR));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 ION", Q_NULLPTR));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", Q_NULLPTR));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 ION", Q_NULLPTR));
        ...
        checkUseStashedsend->setText(QApplication::translate("SendCoinsDialog", "Stashedsend", Q_NULLPTR));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 TX", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
