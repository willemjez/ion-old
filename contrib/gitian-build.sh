...
#osslPatchUrl=https://dev.bitcoincore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
osslTarUrl=https://github.com/cevap/ion/raw/master/contrib/osslsigncode/osslsigncode-1.7.1.tar.gz
osslPatchUrl=https://github.com/cevap/ion/raw/master/contrib/osslsigncode/osslsigncode-Backports-to-1.7.1.patch
