...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/ion/ion/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/ion/ion/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ion/ion.git
...
space *do not upload these to the ion.org server, nor put them in the torrent*.
...
people without access to `ion.org` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
ion.org (see below for ion.org update instructions).

- Update ion.org version

  - First, check to see if the Ion.org maintainers have prepared a
    release: https://github.com/ion-dot-org/ion.org/labels/Releases

      - If they have, it will have previously failed their Travis CI
        checks because the final release files weren't uploaded.
        Trigger a Travis CI rebuild---if it passes, merge.

  - If they have not prepared a release, follow the Ion.org release
    instructions: https://github.com/ion-dot-org/ion.org#release-notes
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ion/ion/releases/new) with a link to the archived release notes.
