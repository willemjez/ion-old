Bitcoin Core versbitcoin 0.10.4 is now available from:
...
versbitcoin FIXME or any versbitcoin from FIXME onward.
...
- #6953 `eae0350` Clarificatbitcoin of unit test build instructbitcoins
...
- #6953 `b3964e3` Drop "with minimal dependencies" from descriptbitcoin
...
- #6953 `3ad96bd` Fix locking in GetTransactbitcoin
