Bitcoin Core versbitcoin 0.11.1 is now available from:

  <https://bitcoin.org/bin/bitcoin-core-0.11.1/>

This is a new minor versbitcoin release, bringing security fixes. It is recommended
to upgrade to this versbitcoin as soon as possible.
...
- #6439 `980f820` Updated URL locatbitcoin of netinstall for Debian
- #6384 `8e5a969` qt: Force TLS1.0+ for SSL connectbitcoins
