Bitcoin-Qt versbitcoin 0.8.6 final is now available from:
...
- OSX block chain database corruptbitcoin fixes
  - Update leveldb to 1.13
  - Use fcntl with `F_FULLSYNC` instead of fsync on OSX
  - Use native Darwin memory barriers
  - Replace use of mmap in leveldb for improved reliability (only on OSX)

- Fix nodes forwarding transactbitcoins with empty vins and getting banned

- Network code performance and robustness improvements

- Additbitcoinal debug.log logging for diagnosis of network problems, log timestamps by default
...
- Various small GUI, documentatbitcoin and build fixes
