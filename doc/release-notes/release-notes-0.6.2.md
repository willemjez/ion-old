Bitcoin versbitcoin 0.6.2 is now available for download at:
...
portable blkindex.dat file then run with the new -detachdb=1 optbitcoin
...
binaries are dynamically linked to the versbitcoin of OpenSSL on the system).
...
- error handling improvements (show message box rather than console exceptbitcoin,
etc.)
- by popular request, make 4th bar of connectbitcoin icon green
