Versbitcoin 0.3.12 is now available.
...
* Recovers and continues if an exceptbitcoin is caused by a message you received.  Other nodes shouldn't be able to cause an exceptbitcoin, and it hasn't happened before, but if a way is found to cause an exceptbitcoin, this would keep it from being used to stop network nodes.
